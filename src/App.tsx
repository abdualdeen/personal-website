    ...
    <div className="App">
      ...
      <div className="mt-24 flex justify-center">
        ...
        <div className="inline-block rounded-md px-3 py-3 text-center text-xl text-white">
          ...
          <h3 className="text-neutral-500">A software engineer with a passion for building software!</h3>
          <div className="mt-20">
            <h4>
      ...
      <div className="mt-20 flex justify-center">
        <h2 className="">Wanna get in touch? Checkout my resume or LinkedIn!</h2>
        {/* <Letter /> */}
      </div>
    </div>
  );
